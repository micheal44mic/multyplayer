...
export const BRUSH_CATEGORIES = [
  {
    ...
    label: 'Simple',
    icon: ICONS.simple,
    items: makePresets('simple', simpleNames, (i) => ({
      ...
      smoothing: [0.52, 0.58, 0.35, 0.42, 0.45, 0.36, 0.4, 0.3, 0.62, 0.48][i],
  ...
  },
  {
    ...
    label: 'Sketch',
    icon: ICONS.sketch,
    items: makePresets('sketch', sketchNames, (i) => ({
      ...
      smoothing: [0.22, 0.18, 0.12, 0.25, 0.25, 0.3, 0.12, 0.08, 0.2, 0.26][i],
      textureOn: true,
  ...
  },
  {
    ...
    label: 'Ink',
    icon: ICONS.ink,
    items: makePresets('ink', inkNames, (i) => ({
      ...
      smoothing: [0.56, 0.64, 0.6, 0.5, 0.58, 0.36, 0.26, 0.42, 0.54, 0.66][i],
  ...
  },
  {
    ...
    label: 'Comic',
    icon: ICONS.comic,
    items: makePresets('comic', comicNames, (i) => ({
      ...
      smoothing: [0.55, 0.72, 0.62, 0.72, 0.5, 0.18, 0.34, 0.18, 0.15, 0.6][i],
  ...
  },
  {
    ...
    label: 'Airbrush',
    icon: ICONS.airbrush,
    items: makePresets('airbrush', airbrushNames, (i) => ({
      ...
      smoothing: [0.28, 0.25, 0.22, 0.3, 0.16, 0.14, 0.34, 0.22, 0.16, 0.24][i],
  ...
  {
    id: 'watercolorFlat',
    label: 'Watercolor (Flat)',
    icon: ICONS.watercolorFlat,
    items: makePresets('watercolorFlat', watercolorFlatNames, (i) => ({
      ...
      smoothing: [0.36, 0.34, 0.28, 0.38, 0.3, 0.26, 0.32, 0.42, 0.24, 0.26][i],
      textureOn: true,
  ...
  },
  {
    ...
    icon: ICONS.watercolorTexture,
    items: makePresets('watercolorTexture', watercolorTextureNames, (i) => ({
      ...
      smoothing: [0.28, 0.22, 0.24, 0.18, 0.22, 0.25, 0.2, 0.26, 0.24, 0.2][i],
      textureOn: true,
  ...
  },
  {
    ...
    label: 'Paint',
    icon: ICONS.paint,
    items: makePresets('paint', paintNames, (i) => ({
      ...
      smoothing: [0.28, 0.3, 0.24, 0.22, 0.16, 0.2, 0.18, 0.28, 0.35, 0.18][i],
  ...
  },
  {
    ...
    label: 'Dry Media',
    icon: ICONS.dry,
    items: makePresets('dry', dryNames, (i) => ({
      ...
      smoothing: [0.08, 0.1, 0.12, 0.16, 0.1, 0.12, 0.2, 0.12, 0.1, 0.16][i],
      textureOn: true,
  ...
  },
  {
    ...
    label: 'FX',
    icon: ICONS.fx,
    items: makePresets('fx', fxNames, (i) => ({
      ...
      smoothing: [0.18, 0.16, 0.28, 0.1, 0.32, 0.12, 0.08, 0.14, 0.2, 0.16][i],
      scatter: true,
