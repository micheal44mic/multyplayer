...
/** @typedef {'brush'|'eraser'|'blur'|'select'|'move'|'pan'} Tool */
...
export const brush = {
  ...
  blurOpacity: 1,      // 0..1: quanto il risultato sfocato entra nel layer
  blurSoftness: 0.65,  // 0..1: bordo duro -> morbido
  color: { r: 26, g: 26, b: 31 },
  tool: 'brush',       // 'brush' | 'eraser' | 'blur' | 'select' | 'move' | 'pan'
};
