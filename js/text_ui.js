...
import { TEXT_FONTS, ensureFont, defaultTextStyle, makeTextItem, textWidth, defaultDistort, distortBox, bumpDistort, touchText } from './text_layer.js';
...
export class TextUI {
  ...
  _build() {
    ...
    body.appendChild(this._slider('Angle', 0, 360, 1,
      ...
      (v) => Math.round(v) + '°'));
    body.appendChild(this._slider('Opacity', 5, 100, 1,
